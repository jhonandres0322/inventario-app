...
import 'package:inventario_app/src_old/core/domain/app_brand.dart';
...
class _MainFormLoadProduct extends StatelessWidget {
  const _MainFormLoadProduct();
